            ...
            <main class="min-h-screen overflow-hidden rounded-t-3xl bg-base-100 p-4 pb-36">
                ...
                <section>
                    <ul class="flex flex-col gap-4">
                        ...
                        <li class="flex items-center justify-between gap-4 p-4 rounded-lg shadow-md">
                            <div class="user__profile flex basis-32 items-center gap-4">
                                <img src="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20261.76%20226.69'%3e%3cpath%20d='M161.096.001l-30.225%2052.351L100.647.001H-.005l130.877%20226.688L261.749.001z'%20fill='%2341b883'/%3e%3cpath%20d='M161.096.001l-30.225%2052.351L100.647.001H52.346l78.526%20136.01L209.398.001z'%20fill='%2334495e'/%3e%3c/svg%3e" width="40" alt=""/><span>apa kek</span></div>
                            <div class="flex flex-col">
